...
def create_model(opt):
    ...
    # NEW: Add Triplane VAE
    elif opt.model == 'triplane-vae':
        from models.triplane_vae_model import TriplaneVAEModel
        model = TriplaneVAEModel()
    ...
    # NEW: Add EDM Triplane text-to-shape
    elif opt.model == 'edm-triplane-txt2shape':
