...
obj_dir = "/content/drive/My Drive/Colab Notebooks/Soft-Fusion-FYP/data/Softnet/01/fold based extension 1dof soft actuator 6 folds short Model 3/model.obj"
