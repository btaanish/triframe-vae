...
def create_sdf_obj(sdfcommand, marching_cube_command, norm_mesh_dir, sdf_dir, obj,
    ...
    sdf_file = os.path.join(sdf_sub_dir, f"{model_id}.sdf")
...
def process_one_obj(sdfcommand,
    ...
    tmp_dir = f'/root/autodl-tmp/SDFusion/test_results_nopre_small_dset/sdf'
...
def process_obj(obj_file, isosurface_dir, sdf_cmd, mcube_cmd, reduce=1, h5_file=None):
    ...
    # todo
    tmp_dir = f'/root/autodl-tmp/SDFusion/test_results_nopre_small_dset/tmp'
    model_dir = f'{tmp_dir}/model'
    norm_mesh_dir = f'{tmp_dir}/norm_mesh'
    sdf_dir = f'{tmp_dir}/sdf'
...
if __name__ == "__main__":
    ...
    obj_file = '/root/autodl-tmp/SDFusion/test_results_nopre_small_dset/obj/txt2shape-accordion pleat-based 1 dof linear bending soft actuator-12.obj'
