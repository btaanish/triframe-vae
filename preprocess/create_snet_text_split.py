...
dataroot = '/root/autodl-tmp/SDFusion/data/ShapeNet'
# csv_file = f'{dataroot}/ShapeNet/text2shape/test.csv'  #captions.tablechair.csv'
csv_file = f'{dataroot}/text2shape/captions.robot.csv'
...
for phase in ['train', 'test']:
    ...
    out_csv = f'{dataroot}/text2shape/captions.robot_{phase}.csv'
